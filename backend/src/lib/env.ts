...
const envSchema = z.object({
  ...
  // Internal token for GitHub Actions cron jobs (e.g. refresh-mv).
  // Auto-generated by Render; must match the secret used in GH Actions.
  JOBS_INTERNAL_TOKEN: z.string().min(1).optional(),
});
